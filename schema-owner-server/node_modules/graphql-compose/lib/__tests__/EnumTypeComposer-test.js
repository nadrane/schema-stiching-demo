...
describe('EnumTypeComposer', () => {
  ...
  beforeEach(() => {
    ...
    etc = new _.EnumTypeComposer(enumType);
  });
  describe('values manipulation', () => {
    ...
    if (_graphqlVersion.graphqlVersion >= 13) {
      it('getFields() from empty Enum', () => {
        const etc2 = _.EnumTypeComposer.create('SomeType');
  ...
  describe('create() [static method]', () => {
    if (_graphqlVersion.graphqlVersion >= 13) {
      it('should create ETC by typeName as a string', () => {
        const myTC = _.EnumTypeComposer.create('TypeStub');

        expect(myTC).toBeInstanceOf(_.EnumTypeComposer);
    ...
    it('should create ETC by type template string', () => {
      const myTC = _.EnumTypeComposer.create('enum SDLEnum { V1 V2 V3 }');
    ...
    it('should create ETC by GraphQLEnumTypeConfig', () => {
      const myTC = _.EnumTypeComposer.create({
        name: 'TestType',
        values: {
          v1: {},
          v2: {}
    ...
    it('should create TC by GraphQLEnumType', () => {
      ...
      const myTC = _.EnumTypeComposer.create(objType);
