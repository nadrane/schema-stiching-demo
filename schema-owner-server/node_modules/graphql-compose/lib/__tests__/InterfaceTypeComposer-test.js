...
describe('InterfaceTypeComposer', () => {
  ...
  beforeEach(() => {
    ...
    iftc = new _.InterfaceTypeComposer(objectType);
  });
  describe('fields manipulation', () => {
    it('getFields()', () => {
      ...
      const iftc2 = _.InterfaceTypeComposer.create('SomeType');
  ...
  describe('create() [static method]', () => {
    it('should create Interface by typeName as a string', () => {
      const myIFTC = _.InterfaceTypeComposer.create('TypeStub');

      expect(myIFTC).toBeInstanceOf(_.InterfaceTypeComposer);
    ...
    it('should create Interface by type template string', () => {
      const myIFTC = _.InterfaceTypeComposer.create(`
    ...
    it('should create TC by GraphQLInterfaceType', () => {
      ...
      const myIFTC = _.InterfaceTypeComposer.create(objType);
  ...
  describe('get()', () => {
    it('should return type by path', () => {
      const myIFTC = new _.InterfaceTypeComposer(new _graphql.GraphQLInterfaceType({
        name: 'Readable',
        fields: {
          field1: {
            type: _graphql.GraphQLString,
  ...
  describe('deprecateFields()', () => {
    let iftc1;
    beforeEach(() => {
      iftc1 = _.InterfaceTypeComposer.create({
        name: 'MyType',
        fields: {
          name: 'String',
          age: 'Int',
  ...
  describe('getFieldTC()', () => {
    const myIFTC = _.InterfaceTypeComposer.create('MyCustomType');
  ...
  describe('typeResolvers methods', () => {
    ...
    beforeEach(() => {
      ...
      KindRedTC = _.TypeComposer.create(`
      ...
      KindBlueTC = _.TypeComposer.create(`
    ...
    it('hasTypeResolver()', () => {
      ...
      expect(iftc.hasTypeResolver(_.TypeComposer.create('NewOne'))).toBeFalsy();
    });
    it('getTypeResolvers()', () => {
