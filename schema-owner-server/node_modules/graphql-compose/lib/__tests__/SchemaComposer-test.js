...
describe('SchemaComposer', () => {
  it('should implements `add` method', () => {
    ...
    const SomeTC = sc.TypeComposer.create({
      name: 'validType'
    });
    sc.add(SomeTC);
  ...
  describe('getOrCreateTC()', () => {
    it('should create TC if not exists', () => {
      ...
      expect(UserTC).toBeInstanceOf(_TypeComposer.TypeComposer);
      expect(sc.has('User')).toBeTruthy();
      expect(sc.hasInstance('User', _TypeComposer.TypeComposer)).toBeTruthy();
  ...
  describe('getTC', () => {
    it('should return TypeComposer', () => {
      ...
      sc.TypeComposer.create(`
        ...
        `);
      expect(sc.getTC('Author')).toBeInstanceOf(_TypeComposer.TypeComposer);
    });
